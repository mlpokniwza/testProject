...
<!DOCYE html>
    ...
    <head>
        ...
        <title>ประเภท บริการฆ่าเชื้อและไวรัส</title>
                    ...
                    <div class="col-12 col-lg-9 col-xl-7">
                        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                            <div class="card-body p-4 p-md-5">
                                ...
                                <h5 class="mb-4 pb-2 pb-md-0 mb-md-3" style="text-align: left;">ประเภท บริการฆ่าเชื้อและไวรัส</h5>
                                <hr class="my-4" />
                                <form action="virusInsertSuccess.php" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <label class="form-label">รวมราคาสุทธิ : 1200</label><br>
                                        <label class="form-label">ภาษีมูลค่าเพิ่ม(7%) : 84</label><br>
                                        <label class="form-label">ราคารวมภาษีมูลค่าเพิ่ม : 1284</label><br>
                                        <input type="hidden" value="1284" name="Payment" id="Payment">
                                    </div>
                                    <hr class="my-4"/>
