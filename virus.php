...
<!DOCYE html>
    ...
    <head>
        ...
        <title>บริการฆ่าเชื้อและไวรัส</title>
                    ...
                    <div class="col-12 col-lg-9 col-xl-7">
                        <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                            <div class="card-body p-4 p-md-5">
                                <h4 class="mb-4 pb-2 pb-md-0 mb-md-3" style="text-align: left;">บริการฆ่าเชื้อและไวรัส</h4>
                                <hr class="my-4" />
                                <form action="virusInsert.php" method="post">
